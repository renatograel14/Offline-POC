...
(function () {
    var provider = app.data.offlineTest = new Everlive({
            offlineStorage: true,
            appId: '1cg3oe3sjbajlbfr',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'offlineTest_access_token',
    ...
    // provider.offlineStorage.purgeAll(function(){}, function(){});
    ...
    document.addEventListener('syncStart', function _appOffline() {
         alert('sync');
    });
...
// START_CUSTOM_CODE_offlineTest
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_offlineTest